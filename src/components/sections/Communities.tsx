...
import { featuredCommunitiesQuery } from "../../../sanity/lib/queries";
import type { Community } from "../../../sanity/lib/types";
...
async function getCommunities(): Promise<Community[]> {
  ...
  try {
    const communities = await client.fetch<Community[]>(featuredCommunitiesQuery);
    return communities && communities.length > 0 ? communities : fallbackCommunities;
  } catch {
    return fallbackCommunities;
  }
}
