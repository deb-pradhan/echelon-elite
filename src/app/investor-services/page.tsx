...
const services = [
  {
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M15.75 15.75l-2.489-2.489m0 0a3.375 3.375 0 10-4.773-4.773 3.375 3.375 0 004.774 4.774zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    ),
        ...
        <div className="relative z-10 container-luxury">
          <div className="max-w-3xl">
            ...
            <h1 className="font-[family-name:var(--font-playfair)] text-5xl md:text-6xl lg:text-7xl text-alabaster leading-tight mb-8">
              White-Glove
              <br />
              <em className="text-gold">Investment</em> Services
            </h1>
            <p className="text-xl text-alabaster/70 leading-relaxed mb-12">
        ...
        <div className="container-luxury">
          ...
          <div className="space-y-8">
            {services.map((service, index) => (
              <div
                key={service.title}
                className="grid grid-cols-1 lg:grid-cols-12 gap-8 py-12 border-b border-marble last:border-b-0"
              >
                {/* Number & Icon */}
                ...
                <div className="lg:col-span-5">
                  ...
                  <h3 className="font-[family-name:var(--font-playfair)] text-2xl text-midnight mb-4">
                    {service.title}
                  </h3>
        ...
        <div className="container-luxury">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-[family-name:var(--font-playfair)] text-4xl md:text-5xl text-alabaster mb-8">
              ...
              <ol className="space-y-6">
                {[
                  ...
                  <li key={index} className="flex items-start gap-4">
                    <span className="w-8 h-8 flex items-center justify-center border border-gold text-gold text-sm">
                      {index + 1}
                    </span>
                    <span className="text-alabaster/80 pt-1">{step}</span>
                  </li>
                ))}
              </ol>
            </div>
            ...
            <div className="bg-charcoal p-12">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-alabaster font-medium mb-1">
                      100% Transparency
                    </h4>
